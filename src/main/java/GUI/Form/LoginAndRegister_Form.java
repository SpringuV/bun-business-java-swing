...
public class LoginAndRegister_Form extends JFrame {
	...
	public LoginAndRegister_Form() {
		...
		// panel intro (đỏ) đặt trên layer trên cùng, ban đầu nằm ở x = FORM_W (che
		// rightForm)
...
// --------------------------------Form Đăng nhập--------------------------------
	private JPanel createLoginPanel() {
		...
		PromptSupport.setPrompt("Số điện thoại", txtUserLogin);
		...
		PromptSupport.setPrompt("Mật khẩu", txtPassLogin);
