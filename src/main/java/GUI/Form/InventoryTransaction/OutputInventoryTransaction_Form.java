 ...
 */
public class OutputInventoryTransaction_Form extends JFrame {
    ...
    private final JLabel lblTitle = new JLabel("Chọn kho xuất");
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(() -> {
            OutputInventoryTransaction_Form f = new OutputInventoryTransaction_Form();
